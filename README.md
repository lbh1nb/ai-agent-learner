...
1. **下载** — 前往 [Releases 页面](https://github.com/lbh1nb/ai-agent-learner/releases)，下载最新版的 `AI Coding Learner-1.2.2-win.zip`
2. **解压** — 将 zip 文件解压到任意目录（如桌面）
3. **运行** — 双击解压目录中的 `AI Coding Learner.exe`

> 也可以下载 `AI Coding Learner 1.2.2.exe` 便携版，双击直接运行，无需解压。
...
打包后会在 `release/` 目录生成：
- `AI Coding Learner 1.2.2.exe` — 便携版，双击即运行
- `AI Coding Learner-1.2.2-win.zip` — 解压版，解压后运行
